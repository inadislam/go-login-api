...
func NewRouter() *mux.Router {
	...
	r.HandleFunc("/active-user", middlewares.BasicMiddleware(http.HandlerFunc(controllers.ActiveUser))).Methods("POST")
	r.HandleFunc("/find-account", middlewares.BasicMiddleware(http.HandlerFunc(controllers.FindYourAccount))).Methods("POST")
	r.HandleFunc("/reset-password", middlewares.BasicMiddleware(http.HandlerFunc(controllers.ForgetPassword))).Methods("POST")
	...
	r.HandleFunc("/active-user", controllers.Cors).Methods("OPTIONS")
	r.HandleFunc("/find-account", controllers.Cors).Methods("OPTIONS")
	r.HandleFunc("/reset-password", controllers.Cors).Methods("OPTIONS")
